...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_split_3x6_3(
        ...
        _______, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                             KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, _______,
                                            KC_ESC,  KC_SPC,  KC_TAB,         LT_LAY,  KC_BSPC, KC_DEL
    ),
    ...
    [_LAYER] = LAYOUT_split_3x6_3(
        _______, DF_QWER, _______, _______, _______, _______,                          _______, _______, _______, _______, _______, _______,
    ...
    [_ARROW] = LAYOUT_split_3x6_3(
        ...
        _______, KC_INS,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,                           _______, _______, _______, _______, _______, _______,
                                            _______, _______, _______,        DF_COL,  _______, _______
    ),
